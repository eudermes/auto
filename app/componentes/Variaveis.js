...
const valorDesejado = AUDI80;

const variaveisFiltradas = arrayDevariaveis.filter(variavel => variavel === valorDesejado);




{/*const arrayDeVariaveis2 = [fiat147, fiat500, fiatbrava];*/}

export default variaveisFiltradas;
